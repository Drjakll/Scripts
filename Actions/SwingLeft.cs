...
public class SwingLeft : Actions {
    ...
    {
        return A.GetCurrentAnimatorStateInfo(1).IsName("CombatSwingLeft") && A.GetCurrentAnimatorStateInfo(1).normalizedTime >= 1.0f;
    }
